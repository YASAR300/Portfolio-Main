...
import vid from '../img/untrip1.mp4'
...
const ProjectsSection = () => {
  ...
  // State to track video playback status for each project
  ...
  useEffect(() => {
    ...
    const projects = [
      ...
      },
      {
        ...
        videoSrc: 'https://example.com/dashboard-demo.mp4',
      },
    ];
    
    // Initialize video states for each project
  ...
  // Update video state when video ends
      ...
      <section ref={sectionRef} className="max-w-7xl mx-auto px-6 md:px-8 mb-32">
        ...
        <div className="space-y-24">
          {[
            ...
            {
              title: 'Social Media Dashboard',
              description: 'Comprehensive analytics platform for social media management with real-time data visualization and actionable insights for multiple platforms.',
              videoSrc: 'https://example.com/dashboard-demo.mp4',
              liveUrl: 'https://dashboard-demo.com',
              github: 'https://github.com/yourusername/dashboard',
              tech: ['React', 'D3.js', 'Firebase', 'Redux'],
              features: ['Real-time analytics', 'Custom charts', 'Multi-platform support', 'Export reports'],
